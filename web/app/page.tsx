          ...
          <div className="features-grid">
            {[
              ...
              },
              {
                ...
                desc: "Trained on a blend of WikiText-103 and TinyStories — combining encyclopedic knowledge with narrative reasoning to maximize learning per token on limited compute.",
              },
              {
                num: "05",
